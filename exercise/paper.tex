...
\title{Centrifuge modelling of submarine landslides} % Title of the document
...
\subsection{What is Loren Ipsum?} %SubSection - 1.1
...
\subsection{Where does it come from?}  %Section - 1.2
...
% ******************************************************************************
\section{This is a section} % Section 2

\subsection{First SubSection} %SubSection - 2.1
...
\subsection{Why do we use Loren Ipsum?} %SubSection - 2.2
...
\subsubsection{This is getting to a bad} % \subsubsection 2.1.1
\dots and some more in the first subsub section otherwise it all looks the same
doesn't it? well we can add some text to it and some more and some more and
some more and some more and some more and some more and some more \dots

\subsubsection{I have more sections?} % subsubsubsections 2.1.2
\dots and some more in the first subsub section otherwise it all looks the same
doesn't it? well we can add some text to it \dots

\subsection*{Section without numbering} %No section numbering here
